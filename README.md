...
Static portfolio page for 19 demo projects across data architecture, AI products, and applied interface work. The site is implemented as a single `index.html` page with local assets in `static/`.
